...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getCookie, setCookie, sanitizeStatusCode, removeResponseHeader, getQuery as getQuery$1, readBody, getRouterParam, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file://D:/Data/Portofolio/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://D:/Data/Portofolio/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://D:/Data/Portofolio/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, joinRelativeURL, parsePath, withLeadingSlash, withTrailingSlash, decodePath, withoutTrailingSlash } from 'file://D:/Data/Portofolio/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file://D:/Data/Portofolio/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://D:/Data/Portofolio/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://D:/Data/Portofolio/node_modules/klona/dist/index.mjs';
import defu, { defuFn, createDefu } from 'file://D:/Data/Portofolio/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/Data/Portofolio/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://D:/Data/Portofolio/node_modules/unhead/dist/server.mjs';
import { createStorage, prefixStorage } from 'file://D:/Data/Portofolio/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Data/Portofolio/node_modules/unstorage/drivers/fs.mjs';
import { stringify, uneval } from 'file://D:/Data/Portofolio/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://D:/Data/Portofolio/node_modules/vue/index.mjs';
import { createHooks } from 'file://D:/Data/Portofolio/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/Data/Portofolio/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/Data/Portofolio/node_modules/node-mock-http/dist/index.mjs';
import { digest } from 'file://D:/Data/Portofolio/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Data/Portofolio/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://D:/Data/Portofolio/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://D:/Data/Portofolio/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/Data/Portofolio/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/Data/Portofolio/node_modules/source-map/source-map.js';
import { createRouterMatcher } from 'file://D:/Data/Portofolio/node_modules/vue-router/vue-router.node.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://D:/Data/Portofolio/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/Data/Portofolio/node_modules/errx/dist/index.js';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://D:/Data/Portofolio/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://D:/Data/Portofolio/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://D:/Data/Portofolio/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"D:/Data/Portofolio/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/Data/Portofolio","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/Data/Portofolio/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/Data/Portofolio/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/Data/Portofolio/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/Data/Portofolio/.data/kv"}));
...
const _m50ZhqTEhoHslS7VJqqt_7hjE_jAThsBPcVqPbfSAY = (function(nitro) {
...
const _XLa7wpK7rLJIO9jlzAZHSfl8rpcm8yij6_OEBTGiwE = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async (context) => {
    ...
    if (!url.pathname.includes("/_i18n/oZ277Hnb") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const rootDir = "D:/Data/Portofolio";
...
const _7KtbBE6YVlaaF4vy8Cu2QUFijpUEyxUwoFioutk5rPQ = (nitroApp) => {
...
const plugins = [
  _m50ZhqTEhoHslS7VJqqt_7hjE_jAThsBPcVqPbfSAY,
_XLa7wpK7rLJIO9jlzAZHSfl8rpcm8yij6_OEBTGiwE,
_7KtbBE6YVlaaF4vy8Cu2QUFijpUEyxUwoFioutk5rPQ,
...
const _3BXWC1 = eventHandler((event) => {
...
const getServerEntry = () => import('file://D:/Data/Portofolio/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file://D:/Data/Portofolio/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _oddLxE = _messagesHandler ;

const _lazy_FPx0eX = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _3BXWC1, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_FPx0eX, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _oddLxE, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_FPx0eX, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_FPx0eX, lazy: true, middleware: false, method: undefined }
];
